  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center flex-shrink-0 px-5 py-6">
        <h1 className="text-3xl font-black mb-2 text-center">Entra nel party</h1>
        <p className="text-stone-500 text-sm mb-1 text-center">
          Inserisci il codice di 6 lettere che ti è stato
        </p>
        <p className="text-stone-600 text-xs mb-6 text-center">
          condiviso per accedere.
        </p>

        <div className="flex flex-col gap-3 w-full">
          <input
            type="text"
            placeholder="Inserisci il codice del party"
            value={code}
